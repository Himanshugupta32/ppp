...
#define S1_TEST_LED_PORT 1U
#define S1_TEST_LED_PIN  0U
...
int main(void)
{
    ...
    uint32_t port_stateHG1= 0;
    uint32_t port_stateHG2 = 0;
    uint32_t port_stateHG3 = 0;
    uint32_t port_stateHG4 = 0;
    ...
    port_stateHG1= GPIO_PortRead(GPIO, S1_TEST_LED_PORT);
    port_stateHG2= GPIO_PortRead(GPIO, S2_TEST_LED_PORT);
    port_stateHG3= GPIO_PortRead(GPIO, D1_TEST_LED_PORT);
    port_stateHG4= GPIO_PortRead(GPIO, D2_TEST_LED_PORT);
    ...
    port_stateHG1 = GPIO_PortMaskedRead(GPIO, S1_TEST_LED_PORT);
    port_stateHG2 = GPIO_PortMaskedRead(GPIO, S2_TEST_LED_PORT);
    port_stateHG3 = GPIO_PortMaskedRead(GPIO, D1_TEST_LED_PORT);
    port_stateHG4 = GPIO_PortMaskedRead(GPIO, D2_TEST_LED_PORT);
    PRINTF("\r\n Masked port read: %x\r\n", port_state);
    ...
    while (1)
    {
        ...
        port_stateHG1 = GPIO_PortRead(GPIO, S1_TEST_LED_PORT);
               if (!(port_stateHG1 & (1 << S1_TEST_LED_PIN)))
               {
                   PRINTF("\r\n Port state: %x\r\n", port_stateHG1);
                   PRINTF("\r\n SPEED FOR MOTOR1");
                   GPIO_PortToggle(GPIO, APP_BOARD_TEST_LED_PORT, 1u << APP_BOARD_TEST_LED_PIN);
               ...
               port_stateHG2 = GPIO_PortRead(GPIO, S2_TEST_LED_PORT);
                       if (!(port_stateHG2 & (1 << S2_TEST_LED_PIN)))
                       {
                           PRINTF("\r\n Port state: %x\r\n", port_stateHG2);
                           PRINTF("\r\n SPEED FOR MOTOR2");
                           GPIO_PortToggle(GPIO, APP_BOARD_TEST_LED_PORT, 1u << APP_BOARD_TEST_LED_PIN);
                       ...
                       port_stateHG3 = GPIO_PortRead(GPIO, D1_TEST_LED_PORT);
                               if (!(port_stateHG3 & (1 << D1_TEST_LED_PIN)))
                               {
                                   PRINTF("\r\n Port state: %x\r\n", port_stateHG3);
                                   PRINTF("\r\n TORQUE FOR MOTOR1");
                                   GPIO_PortToggle(GPIO, APP_BOARD_TEST_LED_PORT, 1u << APP_BOARD_TEST_LED_PIN);
                               ...
                               port_stateHG4 = GPIO_PortRead(GPIO, D2_TEST_LED_PORT);
                                       if (!(port_stateHG4 & (1 << D2_TEST_LED_PIN)))
                                       {
                                           PRINTF("\r\n Port state: %x\r\n", port_stateHG4);
                                           PRINTF("\r\n TORQUE FOR MOTOR2");
                                           GPIO_PortToggle(GPIO, APP_BOARD_TEST_LED_PORT, 1u << APP_BOARD_TEST_LED_PIN);
